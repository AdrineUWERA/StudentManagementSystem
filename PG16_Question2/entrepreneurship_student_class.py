...
# class for Entrepreneurship student that inherits Student class
class EntrepreneurshipStudent(Student):
    def __init__(self, student_email, student_name, gender, date_of_birth, address, phone_number,
                 date_of_enrollment, year): # initialize Entrepreneurship student properties
        ...
        self.major = "Entrepreneurship"  # overrides the major instance variable from parent class
        ...
        # 104 weeks equals to 2 years
        print("Entrepreneurship student registered successfully!")  # displayed to indicate that the student was registered
    ...
    def promote_student(self):
        if self.year == 2:  # checks of the Entrepreneurship student is in his/her final year hence can't be promoted
            ...
            # promotes the student if he/she hasn't reached the final year
    ...
    def change_student_status(self):
        if datetime.date.today() >= self.expected_graduation_date:    # checks if student is done with the studies
            ...
            # displays when the student's graduation date hasn't yet reached 
