...
# creating class InternationalBusinessAndTradeStudent which inherits from class student
class InternationalBusinessAndTradeStudent(Student):
    ...
    # the International Business And Trade degree program
    def __init__(self, student_email, student_name, gender, date_of_birth, address, phone_number,
        ...
        super().__init__(student_email, student_name, gender, date_of_birth, address, phone_number,
                         date_of_enrollment, year)
        self.major = "International Business And Trade"  # student's major is International Business And Trade by default
        self.venture = []  # All International Business And Trade students have a venture
        self.expected_graduation_date = self.date_of_enrollment + datetime.timedelta(weeks=156)  # expected graduation
        # date is calculated by adding 3 years to the date of enrollment which is the duration of this degree program
        ...
        try:
            ...
            with open("student_records.csv", 'r') as student_records:
                ...
                # and using DictWriter method to record student information as values of the fieldnames keys
                        ...
                        print("International Business And Trade student registered successfully!")
        except OSError as e:
            ...
            try:
                ...
                # read_student as a list
                    ...
                    for student in read_student:
                        if self.student_email == student[0]:  # Looping through all lines(students) in the file
