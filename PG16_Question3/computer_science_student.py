...
# creating class ComputerScienceStudent which inherits from class student
class ComputerScienceStudent(Student):
    ...
    def __init__(self, student_email, student_name, gender, date_of_birth, address, phone_number,
        ...
        self.major = "Computer Science"    # student's major is computer science by default
        self.github_username = github_username  # All computer science students have a github account username
        self.expected_graduation_date = self.date_of_enrollment + datetime.timedelta(weeks=208)  # expected graduation
